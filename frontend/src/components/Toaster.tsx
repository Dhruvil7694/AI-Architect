...
const icons: Record<string, React.ReactNode> = {
  ...
  warning: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#f97316' }}>
  ...
  ai_render: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#000' }}>
      ...
      <AnimatePresence>
        {toasts.map((toast) => (
          <motion.div
            ...
            className={`toast-item type-${toast.type}`}
          >
